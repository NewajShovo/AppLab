...
A plain HTML and CSS company website for GitHub Pages. It has no build step or external dependencies.
...
2. Add the contents of this folder to the repository root, or push this folder as the repository root.
